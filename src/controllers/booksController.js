    ...
    return __generator(this, function (_b) {
        switch (_b.label) {
            case 0:
                ...
                return [4 /*yield*/, books_1.default.create({ title: title, description: description, published: published })];
            case 1:
                book = _b.sent();
                response = "Book created successfully\n".concat(JSON.stringify({ book: book }, null, 2));
...
var getAllBooks = function (req, res) { return __awaiter(void 0, void 0, void 0, function () {
    ...
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0: return [4 /*yield*/, books_1.default.findAll()];
            case 1:
                books = _a.sent();
                res.json(books);
                return [2 /*return*/];
...
var updateBook = function (req, res) { return __awaiter(void 0, void 0, void 0, function () {
    var id, _a, title, description, published, book, response;
    return __generator(this, function (_b) {
        switch (_b.label) {
            case 0:
                id = req.params.id;
